 ...
 */
export const deleteUserAgentConfig = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
    ...
    const cfg = await UserAgentConfig.findById(configId).populate('strategyId', 'userId');
